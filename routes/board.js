...
router.patch(
  ...
  isAuth,
  isAuthBoard,
  handleErrorAsync(boardController.updateBoardCover),
  function (req, res, next) {
    /**
     * #swagger.tags = ['Board']
     * #swagger.summary = 'B03-19	更新看板封面'
     * #swagger.security=[{"Bearer": []}]
		  #swagger.parameters['parameter_name'] = {
		        in: 'body',
		        description: 'B03-19	更新看板封面',
		        schema: {
						    "fileURL":"圖片路徑", 
						}
		      }
...
router.delete(
  ...
  isAuth,
  isAuthBoard,
  handleErrorAsync(boardController.deleteBoardCover),
  function (req, res, next) {
    /**
     * #swagger.tags = ['Board']
     * #swagger.summary = 'B03-20	刪除看板封面'
     * #swagger.security=[{"Bearer": []}]
